...
@section('content')
    ...
    <div class="container-fluid" id="mainblock">
        ...
        <div id="card1" class="row h-100 justify-content-center align-items-center">

            <div class="">
                    <a href="#"><button class="btn btn-primary">Meer..</button></a>
                </div>
         ...
         <div id="card2" class="row h-100 justify-content-center align-items-center">

                <div class="">
                        <a href="/creator"><button class="btn btn-primary">Woning Creator</button></a>
                    </div>
